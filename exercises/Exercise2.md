...
5. **Layout inside a partition:** choose either row-wise or columnar format. A PAX layout, row-wise partitions with columnar storage inside each, is also allowed.
